...
import { Droplets, Utensils, Baby, BookOpen, Users } from 'lucide-react';
...
export default function ServicesPage() {
  const serviceCategories = [
    ...
    },
    {
      id: 'infant-feeding',
      icon: Baby,
      title: 'Infant Feeding & Starting Solids Guidance',
    ...
    },
    {
      id: 'prenatal',
      icon: BookOpen,
      title: 'Prenatal Breastfeeding Preparation',
  ...
  return (
    <div className="min-h-screen bg-soft-cream">
                      ...
                      <ul className="space-y-2">
                        {category.details.map((detail, idx) => (
                          <li key={idx} className="flex items-start gap-3">
                            <span className="w-2 h-2 bg-accent-gold rounded-full flex-shrink-0 mt-2"></span>
                            <span className="font-paragraph text-base text-dusty-blue/80">
                              {detail}
                            </span>
                          </li>
                        ))}
                ...
                <div className={index % 2 === 0 ? 'order-2' : 'order-1'}>
                  <Card className="bg-white border-none shadow-lg rounded-3xl overflow-hidden">
                    <CardContent className="p-0">
                      <div className="aspect-[4/3] bg-dusty-blue/10"></div>
                    </CardContent>
                  </Card>
                </div>
              </div>
      ...
      {/* CTA Section */}
      <section className="w-full py-16 md:py-24 bg-dusty-blue">
        <div className="max-w-[100rem] mx-auto px-5 md:px-20">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
